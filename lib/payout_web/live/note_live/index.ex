defmodule PayoutWeb.NoteLive.Index do
  use PayoutWeb, :live_view

  alias Payout.Notes
  alias Payout.Notes.Note
  ...
  @impl true
  def handle_info({PayoutWeb.NoteLive.FormComponent, {:saved, note}}, socket) do
