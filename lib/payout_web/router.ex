defmodule PayoutWeb.Router do
  use PayoutWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {PayoutWeb.Layouts, :root}
  ...
  if Application.compile_env(:payout, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: PayoutWeb.Telemetry
